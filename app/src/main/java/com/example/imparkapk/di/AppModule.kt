...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideAuthApi(@Named("secure") retrofit: Retrofit): AuthApiService =
        retrofit.create(AuthApiService::class.java)

    @Provides
    @Singleton
    fun provideWorkerFactory(@Named("secure") retrofit: Retrofit): WorkerFactory =
        retrofit.create(WorkerFactory::class.java)
