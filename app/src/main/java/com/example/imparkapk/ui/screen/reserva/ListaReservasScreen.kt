    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                FilterChip(
                    text ="Menor preço",
                    selectd =uiState.ordenacaoSelecionada == OrdenacaoEstacionamento.MENOR_PRECO,
                    onSelected ={if (it) viewModel.onOrdenacaoChange(OrdenacaoEstacionamento.MENOR_PRECO)}
                )
