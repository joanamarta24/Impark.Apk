...
import com.example.imparkapk.data.worker.estacionamento.EstacionamentoSyncWorker

object EstacionamentoNetworkMonitor {
    ...
    fun register(context: Context) {
        ...
        val callback = object : ConnectivityManager.NetworkCallback() {
            override fun onAvailable(network: Network) {
                ...
                val work = OneTimeWorkRequestBuilder<EstacionamentoSyncWorker>()
